...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    '和歌山市南大工町の「トリハル」は、明治創業の焼き鳥・鰻の持ち帰り専門店です。120年以上、和歌山の地で、毎朝鰻を捌き、紀州備長炭で焼き続けてきました。店の成り立ちと仕事への考え方をご紹介します。',
  path: '/about',
...
const values = [
  ...
  },
  {
    en: 'AUTHORITY',
    title: '和歌山で、百二十年以上',
    body: '明治に西ノ店で始め、いまは南大工町に店があります。町は移りましたが、商いは一軒のまま続けています。支店は出していません。うまくやる方法があったとしても、一軒でやるほうが、目が届きます。',
  },
  {
    en: 'TRUST',
    title: '売っているものを、隠さない',
  ...
  return (
    <>
      <PageHero
        en="ABOUT"
        title="トリハルについて"
        lead="和歌山市南大工町、フォルテワジマの西隣。明治のころ西ノ店で始まり、いまはこの場所で商いを続けています。120年以上、和歌山で焼き鳥と鰻を売ってきました。特別な日のための店というより、和歌山の人の日常のなかにあった店です。"
        ...
        <div className="mx-auto grid max-w-[92rem] gap-14 lg:grid-cols-[1.05fr_0.95fr] lg:gap-20">
          <Reveal>
            ...
            <div className="mt-10 max-w-[34rem] space-y-6 text-[0.94rem] leading-[2.1] md:text-base">
              <p>
                トリハルが始まったのは、明治のころ。最初の店は、西ノ店にありました。いまは南大工町に店を構えています。町は変わりましたが、扱っているものはほとんど変わっていません。鰻と、焼き鳥。それを焼いて、包んで、お渡しする。
              </p>
              <p>
