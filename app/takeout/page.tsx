...
const reheat = [
  {
    title: '鰻の蒲焼',
    body: 'そのままオーブントースターか電子レンジで、温まる程度にあたためてください。お酒はかけません。味が変わってしまいます。タレは冷たいままで結構ですので、あたためた蒲焼にそのままかけてお召し上がりください。',
  },
  {
    title: '焼き鳥',
        ...
        <div className="mx-auto max-w-[92rem]">
          <Reveal>
            ...
            <p className="mt-8 max-w-[36rem] text-[0.92rem] leading-[2.05] opacity-85">
              買ってすぐが、いちばんおいしい状態です。少し時間が経ったときは、次のようにしていただくと、焼いたばかりの状態に近づきます。余計なものは加えず、そのままあたためるのがいちばんです。
            </p>
          </Reveal>
